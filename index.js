...
const external = "I'm outside the function"; // => Global Scope
...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// The "nestedFunction" function and "internal" variable are both scoped in the "myFunction" function.
// This means that "internal" is available anywhere within the "myFunction" function scope.
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(array){
    return array.reduce((prev, animal) => prev + animal.population, 0);
  }
